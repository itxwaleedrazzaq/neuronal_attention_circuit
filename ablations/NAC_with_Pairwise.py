...
class NAC_PW(tf.keras.layers.Layer):
    ...
    def call(self, inputs, mask=None, training=None):
        ...
        phi, tau, t_interp = self.compute_phi_tau(qh, kh, t)
        ...
        # integration
        vh = tf.expand_dims(vh, axis=2) 
        output = attn_weights[..., tf.newaxis] * vh
        output = tf.reduce_sum(output, axis=3) * self.dt
